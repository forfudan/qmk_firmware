...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_69_ansi(
        KC_TILD,        KC_EXLM,    KC_AT,  KC_HASH,  KC_DLR, KC_PERC, KC_CIRC,  KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,     KC_MINS,  KC_EQL,    KC_BSPC,         KC_MUTE,
        _______,           KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,     KC_7,    KC_8,    KC_9,    KC_0,     KC_LBRC,  KC_RBRC,   KC_BSLS,          KC_DEL,
        _______,        KC_MINS,   KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,           KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,     KC_BSPC,  KC_QUOT,    KC_ENT,         KC_HOME,
        _______,        KC_UNDS,   KC_PLUS, KC_LCBR, KC_RCBR,    KC_PIPE, KC_PIPE, KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END, KC_DEL,   KC_RSFT,           KC_UP,
        _______,           _______,  _______,                 _______,           MO(WIN_FN1), MO(FN2), LT(ADJ,KC_SPC),   KC_RALT,            KC_LEFT, KC_DOWN, KC_RGHT),

    [ADJ] = LAYOUT_69_ansi(
        KC_TILD,        KC_EXLM,    KC_AT,  KC_HASH,  KC_DLR, KC_PERC, KC_CIRC,  KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,     KC_MINS,  KC_EQL,    KC_BSPC,         KC_MUTE,
        _______,          KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,    KC_F7,   KC_F8,   KC_F9,  KC_F10,     KC_LBRC,  KC_RBRC,   KC_BSLS,          KC_DEL,
        KC_CAPS,         KC_F11,   KC_F12,  KC_LBRC, KC_RBRC, KC_BSLS,           KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,     KC_PSCR,  KC_QUOT,    KC_ENT,         KC_HOME,
        AS_TOGG,        KC_UNDS,   KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_PIPE,  KC_HOME, KC_PGDN, KC_PGUP,  KC_END,      KC_DEL,  KC_RSFT,           KC_UP,
        _______,        _______,  _______,          _______,           MO(WIN_FN1), MO(FN2),      _______,               KC_RALT,            KC_LEFT, KC_DOWN, QK_BOOT),
